...
Installing "Metadata Explorer" can be done either by searching for "Metadata Explorer" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
